...
function updateDependencies() {
	...
	# Prevent apt-get/aptitude from showing dialogs during installation
...
function downloadAgent() {
	...
	# Agent.ova is a Windows 7 (x86) virtual machine and is used as a Cuckoo agent
	url="https://drive.google.com/u/0/uc?id=1uGxNwvSuSIhokeuX9N61D8VtyFDoK0-2&export=download"
	# Download Agent.ova from Google Drive
	mkdir ~/Downloads
...
function installCuckooDependencies() {
	...
	# Install pySSDeep, YARA and Volatility
